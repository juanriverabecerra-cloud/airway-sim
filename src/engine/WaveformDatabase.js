...
export const WAVEFORMS = {
  ecg: {
    ...
    normal: (tBeat, beatDuration, h, base, time) => {
      let y = base;
    ...
    vtach: (tBeat, beatDuration, h, base, time) => {
  ...
  aline: {
    ...
    underdamped: (tBeat, beatDuration, h, base, time) => {
    ...
    overdamped: (tBeat, beatDuration, h, base, time) => {
