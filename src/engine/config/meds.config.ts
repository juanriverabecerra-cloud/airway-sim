...
export const MEDICATIONS_CONFIG: Record<string, MedicationProfile> = {
  ...
  midazolam: { 
    ...
    pk: { V1: 12.0, V2: 30.0, V3: 80, k10: 0.12, k12: 0.1, k21: 0.05, k13: 0.03, k31: 0.01, ke0: 0.8, coSensitivity: 0.2, renalFraction: 0.0, hepaticFraction: 1.0 },
  ...
  propofol: { 
    ...
    pk: { V1: 4.27, V2: 18.9, V3: 238, k10: 0.443, k12: 0.303, k21: 0.055, k13: 0.196, k31: 0.0033, ke0: 1.2, coSensitivity: 0.6, renalFraction: 0.0, hepaticFraction: 1.0 },
  ...
  cisatracurium: { 
    ...
    metabolism: 'Hoffmann Elimination', proteinBinding: 0.82, targetReceptor: 'nAChR (Antagonist)', intracellularCascade: 'Competitive antagonist -> blocks ACh binding -> prevents Na+ influx/depolarization',
  ...
  glycopyrrolate: { 
    ...
    metabolism: 'Renal (Unchanged)', proteinBinding: 0.0, targetReceptor: 'Muscarinic (M2/M3)', intracellularCascade: 'Antagonizes M2 (Gi-coupled) at SA/AV node -> prevents cAMP decrease -> increases HR',
  ...
  neostigmine: { 
    ...
    metabolism: 'Hepatic and Renal (50%)', proteinBinding: 0.20, targetReceptor: 'Acetylcholinesterase', intracellularCascade: 'Inhibits AChE -> ACh accumulates -> massive M2 (Gi) activation -> severe bradycardia if unopposed',
  ...
  succinylcholine: { 
    ...
    metabolism: 'Pseudocholinesterase (butyrylcholinesterase) to succinylmonocholine', targetReceptor: 'nAChR (Agonist)', intracellularCascade: 'Depolarizing agonist -> opens Na+/K+ channels -> fasciculations -> desensitization phase',
  ...
  sugammadex: { 
    ...
    metabolism: 'Renal excretion (unchanged)', targetReceptor: 'Rocuronium/Vecuronium',
  ...
  vecuronium: { 
    ...
    metabolism: 'Hepatic (deacetylation 30-40%) to active metabolites, renal 20-30%', proteinBinding: 0.70, targetReceptor: 'nAChR (Antagonist)', intracellularCascade: 'Competitive antagonist -> blocks ACh binding -> prevents Na+ influx/depolarization',
    activeMetabolite: '3-desacetylvecuronium',
    indications: { 'Intubation': { dose: '0.1', unit: 'mg/kg', type: 'Bolus' } },
    pk: { V1: 18.0, V2: 25.0, V3: 0, k10: 0.05, k12: 0.04, k21: 0.04, k13: 0, k31: 0, ke0: 0.08, coSensitivity: 0.2, renalFraction: 0.4, hepaticFraction: 0.6 }, 
  ...
  dopamine: { 
    ...
    metabolism: 'MAO/COMT', targetReceptor: 'D1, Beta-1, Alpha-1', intracellularCascade: 'Low: D1 (Gs -> cAMP). Med: B1 (Gs -> cAMP). High: a1 (Gq -> IP3/DAG/Ca2+)',
  ...
  ephedrine: { 
    ...
    metabolism: 'Hepatic (minimal), mostly excreted unchanged', targetReceptor: 'Alpha-1, Beta-1, Beta-2 (Direct & Indirect)', intracellularCascade: 'Indirect NE release + Direct: a1 (Gq->Ca2+), B1/B2 (Gs->cAMP)',
  ...
  epinephrine: { 
    ...
    metabolism: 'MAO/COMT', targetReceptor: 'Alpha-1, Beta-1, Beta-2', intracellularCascade: 'a1 (Gq -> IP3/DAG/Ca2+), B1/B2 (Gs -> adenylate cyclase -> cAMP)',
  ...
  milrinone: { 
    ...
    metabolism: 'Renal (80% unchanged)', targetReceptor: 'PDE3', intracellularCascade: 'Inhibits PDE3 -> Prevents cAMP degradation -> increased intracellular Ca2+ (inotropy) & smooth muscle relaxation',
  ...
  norepinephrine: { 
    ...
    metabolism: 'MAO/COMT', targetReceptor: 'Alpha-1 > Beta-1', intracellularCascade: 'a1 (Gq -> IP3/DAG/Ca2+), B1/B2 (Gs -> adenylate cyclase -> cAMP)',
    indications: { 'Push Dose': { dose: '10-20', unit: 'mcg', type: 'Bolus' }, 'Shock / Vasoplegia': { dose: '0.01-0.3', unit: 'mcg/kg/min', type: 'Infusion' } },
  ...
  phenylephrine: { 
    ...
    metabolism: 'Hepatic (MAO)', targetReceptor: 'Alpha-1', intracellularCascade: 'Selective a1 (Gq-coupled -> Phospholipase C -> IP3/DAG -> intracellular Ca2+ release)',
  ...
  vasopressin: { 
    ...
    metabolism: 'Tissue Peptidases', targetReceptor: 'V1 Receptors', intracellularCascade: 'V1 (Gq-coupled -> Phospholipase C -> IP3/DAG -> intracellular Ca2+ release in vascular smooth muscle)',
  ...
  clevidipine: { 
    ...
    metabolism: 'Plasma Esterases (hydrolysis)', targetReceptor: 'L-type Calcium', intracellularCascade: 'Dihydropyridine CCB -> blocks L-type VGCCs in vascular smooth muscle -> prevents Ca2+ influx',
  ...
  clonidine: { 
    ...
    metabolism: 'Hepatic / Renal', targetReceptor: 'Alpha-2', intracellularCascade: 'a2 (Gi-coupled) -> inhibits adenylate cyclase -> decreases cAMP',
  ...
  enalaprilat: { 
    ...
    metabolism: 'Renal', targetReceptor: 'ACE',
  ...
  esmolol: { 
    ...
    metabolism: 'RBC Esterases', targetReceptor: 'Beta-1', intracellularCascade: 'B1 antagonist -> blocks Gs-coupled activation -> decreases cAMP in myocardium',
  ...
  hydralazine: { 
    ...
    metabolism: 'Hepatic (N-acetylation)', targetReceptor: 'Arterial Smooth Muscle',
  ...
  labetalol: { 
    ...
    metabolism: 'Hepatic', targetReceptor: 'Alpha-1, Beta-1/2', intracellularCascade: 'Mixed antagonist -> blocks a1 (Gq), B1/B2 (Gs) -> prevents Ca2+ release and cAMP production',
  ...
  metoprolol: { 
    ...
    metabolism: 'Hepatic (CYP2D6)', proteinBinding: 0.12, targetReceptor: 'Beta-1', intracellularCascade: 'B1 antagonist -> blocks Gs-coupled activation -> decreases cAMP in myocardium',
  ...
  nicardipine: { 
    ...
    metabolism: 'Hepatic', targetReceptor: 'L-type Calcium', intracellularCascade: 'Dihydropyridine CCB -> blocks L-type VGCCs in vascular smooth muscle -> prevents Ca2+ influx',
  ...
  nitroglycerin: { 
    ...
    metabolism: 'Hepatic / Blood (rapid enzymatic conversion)', targetReceptor: 'Venous Smooth Muscle',
  ...
  nitroprusside: { 
    ...
    metabolism: 'RBCs (Cyanide release)', targetReceptor: 'Arterial/Venous Muscle',
  ...
  phentolamine: { 
    ...
    metabolism: 'Hepatic', targetReceptor: 'Alpha-1, Alpha-2',
  ...
  acetazolamide: { 
    ...
    metabolism: 'Renal (Unchanged)', targetReceptor: 'Carbonic Anhydrase',
  ...
  bumetanide: { 
    ...
    metabolism: 'Hepatic / Renal', targetReceptor: 'Na-K-2Cl Symporter',
  ...
  furosemide: { 
    ...
    metabolism: 'Renal and Hepatic', targetReceptor: 'Na-K-2Cl Symporter',
  ...
  mannitol: { 
    ...
    metabolism: 'Renal (Unchanged)', targetReceptor: 'Tubular Lumen',
  ...
  adenosine: { 
    ...
    metabolism: 'RBC and Endothelial cell uptake (rapid deamination)', targetReceptor: 'A1 Receptors', intracellularCascade: 'A1 (Gi-coupled) -> inhibits adenylate cyclase (decreased cAMP) -> activates K-ACh channels -> hyperpolarization',
  ...
  amiodarone: { 
    ...
    metabolism: 'Hepatic (CYP3A4) to active desethylamiodarone', targetReceptor: 'Potassium Channels',
  ...
  atropine: { 
    ...
    metabolism: 'Hepatic (50%), renal unchanged (50%)', targetReceptor: 'Muscarinic (M2/M3)', intracellularCascade: 'Antagonizes M2 (Gi-coupled) at SA/AV node -> prevents cAMP decrease -> increases HR',
  ...
  bicarbonate: { 
    ...
    metabolism: 'Reacts to release CO2 via lungs', targetReceptor: 'Plasma pH',
  ...
  calcium: { 
    ...
    metabolism: 'Skeletal / Renal', targetReceptor: 'Myocardium',
  ...
  digoxin: { 
    ...
    metabolism: 'Renal excretion (unchanged)', targetReceptor: 'Na+/K+-ATPase',
  ...
  diltiazem: { 
    ...
    metabolism: 'Hepatic (CYP3A4) to active deacetyldiltiazem', targetReceptor: 'L-type Calcium', intracellularCascade: 'Non-DHP CCB -> blocks L-type VGCCs in myocardium/AV node -> prevents Ca2+ influx',
  ...
  ibutilide: { 
    ...
    metabolism: 'Hepatic', targetReceptor: 'Slow Inward Na+',
  ...
  lidocaine: { 
    ...
    metabolism: 'Hepatic (CYP1A2) to active MEGX', proteinBinding: 0.70, targetReceptor: 'Sodium Channels',
    indications: { 'VT/VF Arrest': { dose: '1.0-1.5', unit: 'mg/kg', type: 'Bolus' } },
    pk: { V1: 30.0, V2: 0, V3: 0, k10: 0.05, k12: 0.08, k21: 0.04, k13: 0, k31: 0, ke0: 1.0, coSensitivity: 0.2, renalFraction: 0.0, hepaticFraction: 1.0 }, 
  ...
  benzocaine: {
    ...
    metabolism: 'Plasma Cholinesterase', proteinBinding: 0, targetReceptor: 'Sodium Channels',
  ...
  prilocaine: {
    ...
    metabolism: 'Hepatic to o-toluidine active metabolite', proteinBinding: 0.55, targetReceptor: 'Sodium Channels',
  ...
  magnesium: { 
    ...
    metabolism: 'Renal excretion', targetReceptor: 'Ca2+/K+ Channels',
  ...
  procainamide: { 
    ...
    metabolism: 'Hepatic (acetylation) to active NAPA', targetReceptor: 'Sodium Channels',
  ...
  sotalol: { 
    ...
    metabolism: 'Renal (Unchanged)', targetReceptor: 'Potassium / Beta-1/2',
  ...
  verapamil: { 
    ...
    metabolism: 'Hepatic', targetReceptor: 'L-type Calcium', intracellularCascade: 'Non-DHP CCB -> blocks L-type VGCCs in myocardium/AV node -> prevents Ca2+ influx',
  ...
  flumazenil: {
    ...
    metabolism: 'Hepatic', proteinBinding: 0.50, targetReceptor: 'GABA-A',
  ...
  papaverine: {
    ...
    metabolism: 'Hepatic', proteinBinding: 0.90, targetReceptor: 'Phosphodiesterase',
  ...
  meperidine: {
    ...
    pk: { V1: 40.0, V2: 60.0, V3: 100.0, k10: 0.05, k12: 0.08, k21: 0.04, k13: 0.02, k31: 0.01, ke0: 0.2, coSensitivity: 0.4, renalFraction: 0.3, hepaticFraction: 0.7 },
  ...
  naloxone: {
    ...
    metabolism: 'Hepatic conjugation', proteinBinding: 0.45, targetReceptor: 'Mu-Opioid',
  ...
  angiotensin_ii: {
    ...
    metabolism: 'Plasma Peptidases (immediate)', targetReceptor: 'AT1',
  ...
  methylene_blue: {
    ...
    metabolism: 'Tissue reduction (to leucomethylene blue)', targetReceptor: 'Nitric Oxide Synthase',
  ...
  heparin: {
    ...
    metabolism: 'Reticuloendothelial clearance', proteinBinding: 0.95, targetReceptor: 'Antithrombin III',
  ...
  protamine: {
    ...
    metabolism: 'Plasma Peptidases', targetReceptor: 'Heparin',
  ...
  tranexamic_acid: {
    ...
    metabolism: 'Renal (mostly unchanged >90%)', proteinBinding: 0.03, targetReceptor: 'Plasminogen',
  ...
  ondansetron: {
    ...
    metabolism: 'Hepatic (CYP3A4/2D6)', proteinBinding: 0.73, targetReceptor: '5-HT3',
  ...
  dexamethasone: {
    ...
    metabolism: 'Hepatic', proteinBinding: 0.70, targetReceptor: 'Glucocorticoid',
  ...
  albuterol: {
    ...
    metabolism: 'Hepatic / Local pulmonary clearance', proteinBinding: 0.10, targetReceptor: 'Beta-2',
  ...
  unasyn: {
    ...
    metabolism: 'Renal (Unchanged >80%)', proteinBinding: 0.20, targetReceptor: 'Bacterial Cell Wall',
  ...
  cefazolin: {
    ...
    metabolism: 'Renal (Unchanged >90%)', proteinBinding: 0.74, targetReceptor: 'Penicillin-Binding Proteins',
  ...
  vancomycin: {
    ...
    metabolism: 'Renal (Unchanged)', proteinBinding: 0.55, targetReceptor: 'D-Ala-D-Ala Peptidoglycan',
  ...
  piperacillin_tazobactam: {
    ...
    metabolism: 'Renal (Unchanged ~68%)', proteinBinding: 0.30, targetReceptor: 'Penicillin-Binding Proteins',
  ...
  meropenem: {
    ...
    metabolism: 'Renal (Unchanged ~70%)', proteinBinding: 0.02, targetReceptor: 'Penicillin-Binding Proteins',
    indications: { 'Severe/Resistant Infection': { dose: '1.0-2.0', unit: 'g', type: 'Infusion' } },
  ...
  gentamicin: {
    ...
    metabolism: 'Renal (Unchanged)', proteinBinding: 0.10, targetReceptor: '30S Ribosomal Subunit',
    indications: { 'Gram-Negative Sepsis': { dose: '5-7', unit: 'mg/kg', type: 'Bolus' } },
  ...
  metronidazole: {
    ...
    metabolism: 'Hepatic (CYP oxidation)', proteinBinding: 0.10, targetReceptor: 'Anaerobic Electron Transport Chain',
    indications: { 'Anaerobic Infection': { dose: '500', unit: 'mg', type: 'Infusion' } },
  ...
  ciprofloxacin: {
    ...
    metabolism: 'Hepatic / Renal (mixed)', proteinBinding: 0.30, targetReceptor: 'Bacterial Topoisomerase',
    indications: { 'Gram-Negative Infection': { dose: '400', unit: 'mg', type: 'Infusion' } },
  ...
  ceftriaxone: {
    ...
    metabolism: 'Biliary / Renal (dual)', proteinBinding: 0.95, targetReceptor: 'Penicillin-Binding Proteins',
  ...
  acetaminophen: {
    ...
    metabolism: 'Hepatic (conjugation & CYP2E1 to NAPQI)', proteinBinding: 0.20,
  ...
  ketorolac: {
    ...
    metabolism: 'Hepatic / Renal', proteinBinding: 0.99,
  ...
  sodiumCitrate: {
    ...
    metabolism: 'Local (gastric chemical neutralization, no systemic metabolism)', proteinBinding: 0.0, targetReceptor: 'N/A (direct chemical acid neutralization)',
  ...
  famotidine: {
    ...
    metabolism: 'Renal (Unchanged)', proteinBinding: 0.15, targetReceptor: 'Histamine H2 Receptor',
  ...
  pantoprazole: {
    ...
    metabolism: 'Hepatic (CYP2C19/3A4)', proteinBinding: 0.98, targetReceptor: 'H+/K+-ATPase (Proton Pump)',
  ...
  metoclopramide: {
    ...
    metabolism: 'Renal (Unchanged)', proteinBinding: 0.30, targetReceptor: 'Dopamine D2 / 5-HT3 / 5-HT4',
  ...
  oxytocin: {
    ...
    metabolism: 'Renal / Hepatic (Oxytocinase)', proteinBinding: 0.30, targetReceptor: 'Oxytocin Receptor',
  ...
  methylergonovine: {
    ...
    metabolism: 'Hepatic', proteinBinding: 0.20, targetReceptor: 'Alpha-1 Adrenergic / Serotonergic',
  ...
  carboprost: {
    ...
    metabolism: 'Pulmonary / Hepatic', proteinBinding: 0.70, targetReceptor: 'Prostaglandin F2-alpha Receptor',
  ...
  misoprostol: {
    ...
    metabolism: 'Hepatic', proteinBinding: 0.0, targetReceptor: 'Prostaglandin E1 Receptor',
  ...
  gabapentin: {
    ...
    metabolism: 'Renal (Unchanged)', proteinBinding: 0.0,
  ...
  mexiletine: {
    ...
    metabolism: 'Hepatic (CYP2D6)', proteinBinding: 0.70,
  ...
  topiramate: {
    ...
    metabolism: 'Hepatic / Renal', proteinBinding: 0.15,
