    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed right-4 bottom-24 z-40 bg-slate-900 border border-slate-700 text-white p-3 rounded-full shadow-2xl hover:scale-105 transition-all flex items-center gap-2 group animate-bounce"
        >
          <MessageSquare size={20} className="text-cyan-400" />
          <span className="text-xs font-bold font-mono">Attending</span>
          {activeAlertsCount > 0 && (
            <span className="absolute -top-1 -right-1 bg-red-500 text-white font-extrabold text-[10px] w-5 h-5 rounded-full flex items-center justify-center border border-slate-900">
              {activeAlertsCount}
            </span>
          )}
        </button>
      ...
      >
        {/* Header */}
        <div className="flex justify-between items-center px-4 py-3 border-b border-slate-800/80 bg-slate-950/40">
        ...
        <div className="p-4 border-b border-slate-800/80 flex flex-col gap-3 bg-slate-950/20">
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-4 custom-scrollbar">
          ...
          <button
            ...
            className="w-full py-3 bg-gradient-to-r from-cyan-800 to-indigo-800 hover:from-cyan-700 hover:to-indigo-700 active:scale-98 text-white text-xs font-black rounded-xl shadow-lg transition-all flex items-center justify-center gap-2 border border-cyan-600/40"
          >
            <HelpCircle size={15} />
        ...
        <div className="border-t border-slate-800 bg-slate-950/60 h-44 flex flex-col">
