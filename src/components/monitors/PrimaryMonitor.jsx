...
export const PrimaryMonitor = ({ patient, vitals, nibp, cycleNibp, isCyclingNibp, hrSpeed, rrSpeed, gasSettings, ventSettings, nibpIntervalMs, setNibpIntervalMs }) => {
  ...
  return (
    <div className="glass-panel glass-emerald p-2 flex flex-col md:grid md:grid-cols-4 gap-2 min-h-[360px] md:min-h-0 md:h-auto lg:h-[420px] relative overflow-hidden">
      ...
      {/* Primary Waveforms */}
      <div className="col-span-1 md:col-span-1 flex flex-col justify-between relative w-full h-[220px] md:h-full gap-1">
      ...
      <div className="col-span-1 md:col-span-3 grid grid-cols-1 md:grid-cols-3 bg-black/45 backdrop-blur-md p-1.5 rounded-lg h-full border border-slate-800/60 shadow-inner gap-1.5 overflow-hidden">
        
        {/* Column 1: HR & SpO2 cards stacked vertically */}
        ...
        {/* Column 2: BP card on top, and EtCO2 & RR cards stacked horizontally on the bottom */}
        <div className="flex flex-col gap-1.5 h-full">
          {/* Blood Pressure Card */}
          <div className="flex-1 bg-slate-900/60 border border-slate-800/80 rounded p-1.5 flex flex-col justify-between hover:border-red-500/30 transition-all overflow-hidden">
          ...
          {/* EtCO2 & RR cards stacked horizontally */}
          <div className="flex gap-1.5 w-full h-[40%]">
            {/* EtCO2 Card */}
            <div className="flex-1 bg-slate-900/60 border border-slate-800/80 rounded p-1.5 flex flex-col justify-between hover:border-yellow-500/30 transition-all overflow-hidden">
              ...
              <div className="flex-grow flex items-center justify-center">
                {patient?.airwaySecured ? (
                  ...
                  <span className="text-[8px] lg:text-[9px] text-slate-500 font-black uppercase tracking-wider select-none text-center">No Airway</span>
                )}
              </div>
            </div>
        ...
        {/* Column 3: Advanced Monitoring Card taking full height */}
        <div className="bg-slate-955/80 border border-slate-800/85 rounded p-1.5 flex flex-col justify-between h-full overflow-hidden shadow-md">
          ...
          <div className="flex-grow flex flex-col gap-1.5 justify-between py-1">
