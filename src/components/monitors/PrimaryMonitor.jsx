      ...
      <div className="col-span-1 grid grid-rows-[23%_26%_23%_28%] bg-black/45 backdrop-blur-md p-1.5 rounded-lg h-full border border-slate-800/60 shadow-inner gap-1.5 overflow-hidden">
        ...
        <div className="flex gap-1.5 w-full h-full">
          ...
          <div className={`flex-1 bg-slate-900/60 border rounded p-1.5 flex flex-col justify-between hover:border-cyan-500/30 transition-all overflow-hidden ${ (vitals?.spo2 || 0) < 88 ? 'animate-alert-hypoxic' : 'border-slate-800/80'}`}>
            ...
            <div className="flex-1 flex items-center justify-center">
              <span className={`text-4xl lg:text-5xl xl:text-6xl font-black leading-none select-all ${ (vitals?.spo2 || 0) < 88 ? 'text-cyan-600 animate-pulse' : 'text-cyan-400'}`}>
                {vitals?.spo2 ?? '--'}%
              </span>
            </div>
          </div>
        ...
        <div className="flex gap-1.5 w-full h-full">
          ...
          <div className="flex-1 bg-slate-900/60 border border-slate-800/80 rounded p-1.5 flex flex-col justify-between hover:border-slate-500/30 transition-all overflow-hidden">
            ...
            <div className="flex-1 flex items-center justify-center">
              <span className={`text-4xl lg:text-5xl xl:text-6xl font-black leading-none select-all ${ (vitals?.rr || 0) < 8 ? 'text-slate-400 animate-pulse' : 'text-white'}`}>
                {vitals?.rr ?? '--'}
              </span>
            </div>
          </div>
