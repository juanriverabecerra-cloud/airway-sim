    ...
    <div className="glass-panel glass-emerald p-2 flex flex-col md:grid md:grid-cols-4 gap-2 min-h-[450px] md:min-h-0 md:h-[380px] lg:h-[450px] relative overflow-hidden">
      ...
      <div className="col-span-1 grid grid-rows-[23%_26%_23%_28%] bg-black/45 backdrop-blur-md p-1.5 rounded-lg h-full border border-slate-800/60 shadow-inner gap-1.5 overflow-hidden">
        ...
        <div className="flex gap-1.5 w-full h-full">
          {/* Heart Rate Card */}
          <div className="flex-1 bg-slate-900/60 border border-slate-800/80 rounded p-1.5 flex flex-col justify-between hover:border-green-500/30 transition-all overflow-hidden">
            <div className="flex justify-between items-center w-full">
              <span className="text-green-500 font-bold flex items-center gap-1 text-[10px] lg:text-xs leading-none uppercase">
                <Heart size={12} className="text-green-500 animate-pulse shrink-0"/>
                <span>HR</span>
              </span>
            </div>
            <div className="flex-1 flex items-center justify-center">
              <span className="text-4xl lg:text-5xl xl:text-6xl font-black text-green-400 leading-none select-all">
                {vitals.hr}
              </span>
            </div>
          </div>
          ...
          {/* SpO2 Card */}
          <div className="flex-1 bg-slate-900/60 border border-slate-800/80 rounded p-1.5 flex flex-col justify-between hover:border-cyan-500/30 transition-all overflow-hidden">
            <div className="flex justify-between items-center w-full">
            ...
            <div className="flex-1 flex items-center justify-center">
              <span className={`text-4xl lg:text-5xl xl:text-6xl font-black leading-none select-all ${vitals.spo2 < 88 ? 'text-cyan-600 animate-pulse' : 'text-cyan-400'}`}>
                {vitals.spo2}%
              </span>
            </div>
          </div>
        ...
        <div className="bg-slate-900/60 border border-slate-800/80 rounded p-1.5 flex flex-col justify-between hover:border-red-500/30 transition-all overflow-hidden">
          ...
          <div className="flex-1 flex items-center justify-center py-0.5">
            <span className="text-3xl lg:text-4xl xl:text-5xl font-black text-red-400 leading-none tracking-tighter select-all">
        ...
        <div className="flex gap-1.5 w-full h-full">
          ...
          <div className="flex-1 bg-slate-900/60 border border-slate-800/80 rounded p-1.5 flex flex-col justify-between hover:border-yellow-500/30 transition-all overflow-hidden">
            ...
            <div className="flex-1 flex items-center justify-center">
              {patient.airwaySecured ? (
                <span className="text-4xl lg:text-5xl xl:text-6xl font-black text-yellow-400 leading-none select-all">{vitals.etco2}</span>
              ) : (
          ...
          <div className="flex-1 bg-slate-900/60 border border-slate-800/80 rounded p-1.5 flex flex-col justify-between hover:border-slate-500/30 transition-all overflow-hidden">
            ...
            <div className="flex-1 flex items-center justify-center">
              <span className={`text-4xl lg:text-5xl xl:text-6xl font-black leading-none select-all ${vitals.rr < 8 ? 'text-slate-400 animate-pulse' : 'text-white'}`}>
                {vitals.rr}
              </span>
            </div>
          </div>
