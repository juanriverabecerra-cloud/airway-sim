...
new_body_svg = """const BodySvg = ({ activity, hoveredSite, onSiteEnter, onSiteLeave }) => {
  ...
  return (
    <svg viewBox="0 0 360 510" className="w-full select-none" style={{ height: "auto", display: "block" }}>
      ...
      {/* Spine Outer Panel border and shadow */}
      ...
      {/* ═══ ORGANS — minimal iconic representations (WIDER) ════════════════════════ */}
      ...
      <path d="M 206,198 C 201,192 195,192 195,201 C 195,212 206,226 206,226 C 206,226 217,212 217,201 C 217,192 211,192 206,198 Z"
            {...vis('cardiac')}/>

      {/* Lungs: bilateral simple arches (WIDER) */}
      <path d="M 155,185 C 144,187 138,202 138,222 C 138,234 146,236 155,227 C 162,220 166,202 164,187 Z" {...vis('pulmonary')}/>
      <path d="M 205,185 C 216,187 222,202 222,222 C 222,234 214,236 205,227 C 198,220 194,202 196,187 Z" {...vis('pulmonary')}/>
      ...
      {/* GI: single clean stomach + intestinal loop (WIDER) */}
      <path d="M 170,261 C 170,253 196,251 196,263 C 196,273 184,279 172,275 C 166,272 170,265 170,261 Z" {...vis('gi')}/>
      <path d="M 166,279 C 166,287 194,287 194,281 C 194,275 166,275 166,283 C 166,291 194,291 194,285 C 194,281 180,281 180,281" {...line('gi', 0.9)}/>
